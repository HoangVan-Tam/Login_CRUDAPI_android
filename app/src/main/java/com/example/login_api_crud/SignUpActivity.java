...
public class SignUpActivity extends AppCompatActivity {
    ...
    private void Resigter() {
        ...
        if(TextUtils.isEmpty(email)){
            ...
            passwordEt2.setError("Enter confirm your password");
            return;
        }
        else if(!password.equals(password2)){
            passwordEt2.setError("Confirm password not correct");
            return;
        }
        ...
        firebaseAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(SignUpActivity.this,"Register not successfully",Toast.LENGTH_LONG).show();
                }
